...
<div class="row">
    <div class="col-6"><label for="pi_enable_additional_charges" class="text-light mb-0"><?php _e('Increase / Decrease Fees by this extra rules', 'conditional-extra-fees-woocommerce'); ?></label><?php pisol_help::inline('inc_dec_fees_help', 'Increase / Decrease Fees '); ?></div>
    <div class="col-6">
