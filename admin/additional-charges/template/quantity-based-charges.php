...
<div class="row">
    <div class="col-6"><label for="pi_enable_additional_charges_cart_quantity" class="mb-0 text-light"><?php _e('Change Fees based on Cart Quantity', 'conditional-extra-fees-woocommerce'); ?></label> <?php //pisol_help::youtube('0CTSrfgaKvc','Know more about the Cart Quantity based charge'); ?></div>
    <div class="col-6">
...
<table id="cart_quantity_charges_table" class="table">
    <thead>
        <tr>
            ...
            <th class="pi-fee-col"><?php _e('Fees', 'conditional-extra-fees-woocommerce'); ?> <?php pisol_help::inline('cart_weight_short_code_help', 'Using short code'); ?></th>
            <th></th>
        </tr>
    </thead>
    <tbody>
